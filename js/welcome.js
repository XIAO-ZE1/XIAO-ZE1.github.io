...
$.ajax({
    ...
    data: {
        key: '7EBBZ-MTERM-WQT6C-6GRAS-B5SJZ-FQBJH',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(108.94586, 34.15559, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
